...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ url('assets-login/img/favicon.png') }}" rel="icon">
  <link href="{{ url('assets-login/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
...
<body>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Silahkan Login Ke Admin</h5>
                    <p class="text-center small">Isi Username dan Password Untuk Login</p>
                  </div>

                  <form action="{{ route('authenticate') }}" class="row g-3 needs-validation" novalidate method="POST">
                    @csrf
                    <div class="col-12">
  ...
  <script src="{{ url('assets-login/vendor/chart.js/chart.umd.js') }}"></script>
