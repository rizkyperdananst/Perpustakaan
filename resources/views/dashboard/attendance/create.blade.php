                        ...
                        <form action="{{ route('attendance.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    @error('tanggal')
                                        <div class="alert alert-danger mt-1 mb-1 m-p-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    <button class="btn btn-info float-end ms-3">Add Absensi</button>
                                    <a href="{{ route('attendance.index') }}" class="btn btn-warning float-end">Data Absensi</a>
                                </div>
                            </div>
                        </form>
                    </div>
